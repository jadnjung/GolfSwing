...
- Build **Level 1** as part of the normal Phase 2/3 overlay work — it's low-risk, high-value (users get *something* immediately), and shares infrastructure with the skeleton/angle overlay already planned.
